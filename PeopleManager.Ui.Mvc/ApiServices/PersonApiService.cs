...
namespace PeopleManager.Ui.Mvc.ApiServices
{
    public class PersonApiService
    {
        ...
        public async Task<PagedServiceResult<PersonResult>> FindAsync(Paging? paging = null)
        {
            if (paging is null)
            {
            ...
            var people = await httpResponse.Content.ReadFromJsonAsync<PagedServiceResult<PersonResult>>();

            return people ?? new PagedServiceResult<PersonResult>{Paging = paging};
        }
