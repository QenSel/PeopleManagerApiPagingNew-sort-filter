...
namespace PeopleManager.Ui.Mvc.ApiServices
{
    public class VehicleApiService
    {
        ...
        public async Task<PagedServiceResult<VehicleResult>> Find(Paging? paging = null)
        {
            if (paging is null)
            {
            ...
            var vehicles = await httpResponse.Content.ReadFromJsonAsync<PagedServiceResult<VehicleResult>>();

            return vehicles ?? new PagedServiceResult<VehicleResult>{Paging = paging};
        }
